...
@WebServlet("/driver/dashboard/get-chart-data")
public class DriverGetChartdata extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private BookingsDAO bookingsDAO;

	public DriverGetChartdata() {
		super();
	}
	...
	private void sendDriverChartData(HttpServletRequest request, HttpServletResponse response)
		...
		List<Bookings> bookings = bookingsDAO.selectDriverMnthRev(driver_id);
