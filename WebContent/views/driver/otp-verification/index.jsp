...
<body>
		<div class="popup" style="height: auto;">
			<form class="signinForm" method="post" action="/GoCheeta/driver/signUp/acc-verify">
				...
				<h3
					...
					OTP code send to this mail. : <span style="color: #ffeb3b;" id="driverMailTxt"><c:out value="${driver_email}" /></span>
				</h3>
				<input type="hidden" name="driverMail" value="<c:out value="${driver_email}" />">
				<div>
