	...
	<section class="service_section layout_padding">
		<div class="container">
			<div class="heading_container">
				<h2>
					Our <br> Taxi Services
				</h2>
			</div>
			<div class="service_container">
				<div class="box">
					<div class="img-box">
						<img src="${initParam['basePath']}/assets/images/delivery-man.png"
							alt="">
					</div>
				...
				<div class="box">
					<div class="img-box">
						<img src="${initParam['basePath']}/assets/images/airplane.png"
							alt="">
					</div>
					<div class="detail-box">
				...
				<div class="box">
					<div class="img-box">
						<img
							src="${initParam['basePath']}/assets/${initParam['basePath']}/assets/images/backpack.png"
							alt="">
					</div>
					<div class="detail-box">
